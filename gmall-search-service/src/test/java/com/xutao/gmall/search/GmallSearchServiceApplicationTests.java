package com.xutao.gmall.search;
...
public class GmallSearchServiceApplicationTests {
    ...
    public void put() throws IOException {
        ...
        pmsSkuInfoList = skuServiceImpl.getAllSku();
        ...
        for (PmsSearchSkuInfo pmsSearchSkuInfo : pmsSearchSkuInfos) {
            System.out.println("名称："+pmsSearchSkuInfo.getSkuName()+"----imgURI:"+pmsSearchSkuInfo.getSkuDefaultImg());
